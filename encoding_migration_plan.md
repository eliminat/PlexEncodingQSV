...
*   **Primary Goal:** Consolidate `Encode.sh`, `Encode_HEVC.sh`, and `Audio_Only.sh` into a single `Encode.sh`.
*   **Key Improvements:**
...
2.  **Core Script:** Build `Encode.sh` with array-based command construction.
